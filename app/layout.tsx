...
export const metadata: Metadata = {
  title: "Quốc Hùng & Thùy Trang Wedding site!",
  description:
    "Quốc Hùng & Thùy Trang - Our wedding date: 2025-10-26 | Họ chọn nắm tay nhau, không phải vì giống nhau hoàn toàn – mà vì bên nhau, họ là phiên bản tốt hơn của chính mình.",
};
